...
$date=date("d-m-y @ g:i A");
          ...
          $folder="coordinatorimages/" ;  
          $pd=uniqid().'_'.$pix; 
          
          move_uploaded_file($temp,$folder.$pd)  ;

$da=mysqli_query($con,"insert into top_user(name,email,password,phoneno,level,image,date_created) values('$name','$email','$password','$phoneno','coordinator','$pd','$date')");
if ($da) {

$_SESSION['cmsg']='<span style="color:#fff;">'."Co-ordinator Data added successfully....".'</span>';

} else {
  $_SESSION['cmsg']='<span style="color:#000;">'."Error in adding Co-ordinator Data....".'</span>';
          ...
          <div class="col-md-12">
           <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Co-ordinator : &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
