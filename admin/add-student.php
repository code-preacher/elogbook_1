...
$da=mysqli_query($con,"insert into student(name,matno,password,email,phoneno,cname,caddress,cspecialization,image,supervisor,date_created) values('$name','$matno','$password','$email','$phoneno','$cname','$caddress','$cspecialization','$pd','$sup','$date')");
if ($da) {
mysqli_query($con,"insert into stat(matno,name,supervisor,coordinator,hod) values('$matno','$name','0','0','0')");
...
<div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="cname" class="form-control" id="exampleInputCompanyName" placeholder="Please enter company name" required="required">
                  </div>
                </div>

   <div class="col-sm-12">
                  <div class="form-group">
                    <label for="exampleInputCompanyAddress">Address of Company of Industrial Attachment :</label>
                    <input type="text" name="caddress" class="form-control" id="exampleInputCompanyAddress" placeholder="Please enter company address" required="required">
                  </div>
                </div>     

                <div class="col-sm-12">
                  <div class="form-group">
                    <label for="exampleInputCompanySpecialization">Specialization of Company of Industrial Attachment :</label>
                    <input type="text" name="cspecialization" class="form-control" id="exampleInputCompanySpecialization" placeholder="Please enter company address" required="required">
                  </div>
                </div> 
                <div class="col-sm-6">
                <div class="form-group">
                  <label for="exampleInputSup">Select/Allocate Supervisor:</label>
                  <select required="required" class="form-control" id="exampleInputSup" name="sup">
                        <?php
                $rt=mysqli_query($con,"select name from top_user where level='supervisor' ");
