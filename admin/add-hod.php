...
$da=mysqli_query($con,"insert into top_user(name,email,password,phoneno,level,image,date_created) values('$name','$email','$password','$phoneno','hod','$pd','$date')");
if ($da) {

$_SESSION['smsg']='<span style="color:#fff;">'."Head of Department Data added successfully....".'</span>';

} else {
  $_SESSION['smsg']='<span style="color:#000;">'."Error in adding Head of Department Data....".'</span>';
        ...
        <div class="row mb-2 bg-dark">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Head of Department</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
           <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Head of Department : &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
