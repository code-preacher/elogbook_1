...
$mt=mysqli_query($con,"select * from top_user where level='supervisor'");
?>
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">View all Supervisor </h3>
            </div>
            <!-- /.card-header -->
...
while ($dy=$mt->fetch_array()) {
         ?>
                  <tr>
                    ...
                    <td><a  href="view-spf.php?id=<?php echo $dy['id']; ?>" ><i class="fa fa-eye"></i></a></td>
