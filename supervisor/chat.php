...
if(isset($_POST['comment'])) {
   ...
   $q = $con->prepare('insert into chat (sender,reciever,chat,date) values (?, ?, ?, ?)');
    $q->bind_param('ssss',$nm,$to,$chat,$date);
    $q->execute() ; 
if ($q) {
...
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
    ...
    <br>
      ...
      <label>Select student to chat :<br/>
        <select name="stud" style="width: 200px;">
          <?php
                $rt=mysqli_query($con,"select name from student where supervisor='$nm' ");
