...
#top_users
$ret4=mysqli_query($con,"SELECT * FROM top_user WHERE email='$email' and password='$pass'");
...
if ($dt=='supervisor') {
$extra="../supervisor/dashboard.php";
$_SESSION['email']=$_POST['email'];
$_SESSION['login']=1;
$host=$_SERVER['HTTP_HOST'];
$uri=rtrim(dirname($_SERVER['PHP_SELF']),'/\\');
header("location:http://$host$uri/$extra");
	...
	elseif ($dt=='coordinator') {
$extra="../coordinator/dashboard.php";
$_SESSION['email']=$_POST['email'];
$_SESSION['login']=1;
$host=$_SERVER['HTTP_HOST'];
$uri=rtrim(dirname($_SERVER['PHP_SELF']),'/\\');
